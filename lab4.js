...
const dictionary = {
  "python": "Мова програмування для розробки веб-додатків, аналізу даних, автоматизації і наукових обчислень",
  "js": "Мова програмування для створення інтерактивних і динамічних веб-сторінок"
};
function searchWord() {
